...
pub(crate) fn lattice_request_to_muon_request<T: LtContract>(
    contract: T,
) -> Result<HttpReq, LatticeError> {
...
pub(crate) fn from_muon_res_to_lattice_error<T: LtContract>(
    response: HttpRes,
...
pub(crate) fn lattice_error_to_api_error(value: LatticeError) -> ApiServiceError {
    match value {
