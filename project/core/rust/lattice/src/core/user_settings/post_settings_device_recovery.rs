...
pub struct LtCorePostDeviceRecoverySettingsReq {
    pub recovery_secret: Sensitive<String>,
    pub signature: Sensitive<String>,
}

impl LtContract for LtCorePostDeviceRecoverySettingsReq {
...
impl AuthReq for LtCorePostDeviceRecoverySettingsReq {}
