...
## [mail-uniffi-v0.167.4] - 2026-06-11

### Fixes

- [ET-6366] Fix contact group update by remote id


## [mail-uniffi-v0.167.3] - 2026-06-10
...
- Move deleted-items check inside `quiet_tx` in conversation scroller source - proton/clients/monorepo!1523
...
- [ET-5884] Fix label counter fetching in v6 events
...
- Add additional lock tooltips for e2e external

### Fixes

- [ET-5760] Show privacy lock for imported messages with missing headers
...
- [ET-5697] Backport dangling session fix

## [mail-uniffi-v0.161.9] - 2026-01-19

### Features

- [ET-5737] [breaking] Add scroller's uuid to each list update produced with given scroller
...
- [ET-5718] Handle unresolved label ids

## [mail-uniffi-v0.161.6] - 2026-01-14

### Changed

- [ET-5689] Privacy Lock Refactor

### Features

- [ET-5689] Privacy Locks for composer recipients

## [mail-uniffi-v0.161.5] - 2026-01-13

### Features

- [ET-5591] UTM cleaned links list
- [ET-5591] Breaking change - introducing get/watchPrivacyInfo which replaces get/watchTrackerInfo
- [ET-5657] Breaking Change - Rename OtherNetwork to NetworkFailure

## [mail-uniffi-v0.161.4] - 2026-01-12

### Features

- [ET-5690] Privacy Lock (Sent & Drafts)
- [ET-5691] Privacy lock for remaining messages

### Fixes

- [ET-5440] MessageOrConversationDependencyFetcher is able to fetch labels with missing parenthood
- Do not assume we can unwrap in HTML transformer

## [mail-uniffi-v0.161.3] - 2026-01-08

### Fixes

- Some SVGs not displayed in iOS webview
- [ET-5624] Use correct context when retrieving TrackerDetector
- [ET-5670] Ignore missing conversations
...
- [ET-5619] Improve v6 event subscriber parallelism

### Fixes

- scroller: Include request's time in the debouncing
- bump JNA to 5.18.1 to fix runtime crashes (Android)
- [ET-5633] Fix Contact Email save/load
- [ET-5633] Label event handling
...
- [ET-5603] Fix bug in draft conversation update
...
## [mail-uniffi-v0.160.8] - 2025-12-12

### Fixes

- Correctly handle event loop dependency fetcher network error

## [mail-uniffi-v0.160.7] - 2025-12-12

### Fixes

- [ET-5563] Correct Contact Update events
- Only fetch relevant legacy feature flags
- mailto: Run text2html if we're building a text/html draft
- mailto: Append signature(s)
...
- uniffi: Remove unused `search_for_messages()`
- uniffi: Remove unused `test_stub_message_body()`
- uniffi: Remove unused `messages_for_label()`
- uniffi: Remove unused `messages_for_conversation()`
- uniffi: Remove unused `watch_messages_for_label()`
- uniffi: Remove unused `watch_available_label_as_actions_for_conversations()`
- uniffi: Remove unused `conversations_for_label()`
- uniffi: Remove unused `watch_conversations_for_label()`
- uniffi: Remove unused `watch_available_move_to_actions()`
- uniffi: Remove unused `set_default_mobile_conversation_toolbar_actions()`
- uniffi: Remove unused `set_default_mobile_message_toolbar_actions()`
- uniffi: Remove unused `set_default_mobile_list_toolbar_actions()`
- uniffi: Remove unused `watch_available_label_as_actions_for_messages()`
- uniffi: Remove unused `avatar_information_from_name_and_email()`
- uniffi: Remove unused `load_conversation()`
- uniffi: Remove unused `MailUserSession::watch_labels()`

### Features

- Legacy feature flags - allow Proton to override overriden values
- Global & User flags popup in TUI
- Allow user to override locally unknown flag

### Fixes

- [ET-5470] Get rid of the "conversation has no messages" error

## [mail-uniffi-v0.160.4] - 2025-12-03

### Features

- Wake up feature flags bg task when active context map is updated

### Fixes

- [ET-5531] Add extra new line in drafts before signature
- Fix query behind the `resync_user` flag

## [mail-uniffi-v0.160.3] - 2025-12-02

### Fixes

- Legacy feature flags are deserializing
- Ignore timeout errors, react only on event stream termination
- [ET-5521] Process background-color for linear gradients

## [mail-uniffi-v0.160.2] - 2025-12-02

### Fixes

- [ET-5383] Force resync user data after login
- [ET-5389] attachment-upload: Keep action alive during apply_remote()
