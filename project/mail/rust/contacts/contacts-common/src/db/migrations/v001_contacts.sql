...
CREATE UNIQUE INDEX IF NOT EXISTS index_contact_remote_id ON contacts (remote_id);
...
CREATE INDEX IF NOT EXISTS index_contact_emails_email ON contact_emails (email);

CREATE INDEX IF NOT EXISTS index_contact_emails_contact_local_id ON contact_emails (local_contact_id);

CREATE INDEX IF NOT EXISTS index_contact_emails_contact_remote_id ON contact_emails (remote_contact_id);
...
CREATE INDEX IF NOT EXISTS index_contact_cards_local_id ON contact_cards (local_contact_id);

CREATE INDEX IF NOT EXISTS index_contact_cards_remote_id ON contact_cards (remote_contact_id);

CREATE TABLE IF NOT EXISTS contact_email_labels (
...
CREATE INDEX IF NOT EXISTS index_contact_email_label_id ON contact_email_labels (contact_emails_id);
